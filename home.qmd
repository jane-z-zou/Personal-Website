...
-   **Software Engineer** \@ NoteFlow with Folioworks + Canva --- Built a Canva AI extension that generates speaker notes with tone control, timing, and live preview using TinyLlama + Hugging Face. 🎤🧠\
-   **Software Engineer** \@ EditGuru with Folioworks + Canva --- Created a Canva extension that tracks slide edits by user, surfacing collaboration insights with real-time summaries and contribution metrics. 🧩📊\
...
My work is rooted in the belief that kindness matters, and I hope to build things that reflect that. Outside of work, I thrive on continuous growth through reading speculative and science fiction, crafting, or vlogging everyday moments. I value connection, creativity, and authenticity in all that I do. 📖🧶📸
